...
const Events = () => {
  const { getTickets, loading, error, isConnected } = useTicketNFT();
  ...
  const handleCreateEvent = (eventData: any) => {
    // Atualiza a lista de tickets após criar o evento
    fetchAllTickets();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {!showCreateForm ? (
          ...
          <div className="flex justify-center">
            <EventForm onSubmit={handleCreateEvent} onCancel={handleCancelCreate} />
          </div>
        )}
      </div>
    </div>
